...
vi.mock("@/hooks/useConversations", () => ({
  ...
  useMoveSessionToProfile: () => ({ mutate: vi.fn(), isPending: false, isError: false }),
  useDeleteProject: () => ({ mutate: vi.fn(), isPending: false, isError: false }),
  useRenameProject: () => ({ mutate: vi.fn(), isPending: false, isError: false }),
  useMoveProjectToProfile: () => ({ mutate: vi.fn(), isPending: false, isError: false }),
  useMoveProjectFolderToProfile: () => ({ mutate: vi.fn(), isPending: false, isError: false }),
  useAddProjectRootToPrivateProfile: () => ({ mutate: vi.fn(), isPending: false, isError: false }),
